...
class PipelineManager final {
  ...
  private:
    ...
    bool _createRoverCameraFBPipelineLayout(PipelineLayoutName pipelineLayoutName);
    ...
    bool _createRoverCameraFBPipeline(const RenderPassDescriptor& renderPassDescriptor);
