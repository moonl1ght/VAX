...
class PrimitivesBuilder {
  public:
    ...
    std::optional<vax::objects::DrawableModel> createCube(float size, vax::Color color, uint32_t ssboIndex);
    std::optional<vax::objects::DrawableModel> createPlane(uint32_t ssboIndex);
